...
export const productsData = {
  "d365-data-migration": {
    ...
    blocks: [
      ...
      {
        type: "paragraph",
        text: "Turn your Dynamics 365 migration into a controlled, repeatable, low-risk process.",
      },
      {
        type: "paragraph",
        text: "Every major digital initiative depends on one critical asset: clean, reliable, and well-governed data. For organizations moving to Microsoft Dynamics 365, the largest barrier to success is rarely the platform—it’s the uncertainty of data migration.",
      },
      {
        type: "paragraph",
        text: "Our automated migration engine removes that uncertainty and gives leaders the one thing they rarely get during transformation: confidence.",
      },
      {
        type: "highlight",
        bg: "#00255d",
      ...
      {
        type: "paragraph",
        text: "Your business shouldn’t be one of them. We turn your highest-risk project phase into your most controlled one.",
      },
      ...
      // SECTION — LGS Difference
      {
        type: "section-title",
        title: "The LGS Difference",
      },
      {
        type: "paragraph",
      ...
      // SECTION — Business Impact
      {
        type: "section-title",
        title:
          "The Business Impact: Faster Value, Lower Risk, Stronger Outcomes",
      },
      {
        type: "paragraph",
      ...
      {
        type: "paragraph",
        text: "When the migration becomes predictable, the entire transformation becomes predictable.",
      },
  ...
  "AX2012-upgrade": {
    ...
    blocks: [
      // HERO
      {
        ...
        subheading:
          "Unlock performance, security, and scalability in one move.",
  ...
  "Legacy-application": {
    ...
    blocks: [
      ...
      {
        type: "section-title",
        title: "The Cost and Risk of Keeping Legacy Systems Alive",
      },

      {
        type: "paragraph",
        text: "Across industries, organizations continue running outdated applications long after their operational value has ended—simply because historical data is trapped inside them. These systems drain budgets, increase cyber-risk, and slow modernization efforts. The result? Heavy maintenance costs, audit delays, security exposure, and an IT landscape that becomes harder to evolve each year.",
      },

      {
        type: "paragraph",
        text: "Our Legacy Application to Fabric Data Archive Solution provides a secure, scalable way to retire legacy systems without losing access to the critical data they contain. You keep the data, eliminate the system, and reduce cost and risk instantly.",
      },
      ...
      {
        type: "paragraph",
        text: "This solution archives legacy datasets into Microsoft Fabric using compression, deduplication, indexing, and long-term searchable retention.",
      },
      {
        type: "subheading",
        text: "You gain:",
      ...
      {
        type: "paragraph",
        text: "This approach allows your business to move forward—without dragging outdated systems along.",
      },
      ...
      {
        type: "paragraph",
        text: "Legacy applications represent more than IT complexity—they impact core business priorities:",
      },
      {
        type: "bullets",
        items: [
      ...
      {
        type: "paragraph",
        text: "Archiving to Fabric directly improves cost, risk, and strategic agility.",
      },
      ...
      {
        type: "paragraph",
        text: "This is a fully managed, enterprise-ready archiving model designed for long-term ROI.",
      },
      ...
      {
        type: "paragraph",
        text: "Microsoft Fabric provides measurable improvements in performance, accessibility, governance, and operational efficiency—ensuring your archived data continues delivering value long after legacy systems are retired.",
      },
      {
        type: "tiles",
        tiles: [
      ...
      {
        type: "paragraph",
        text: "These enterprise-grade advantages reduce risk, improve operational efficiency, and ensure long-term data accessibility.",
      },
      ...
      {
        type: "paragraph",
        text: "Fabric ensures your archive remains accessible, compliant, and cost-efficient for years ahead.",
      },
  ...
  "NAXT2012-to-NAXT365": {
    ...
    blocks: [
      ...
      {
        type: "paragraph",
        text: "Running on NAXT2012 introduces risks and inefficiencies: limited support, siloed data, heavy customizations, and slower, disconnected processes.",
      },
      {
        type: "paragraph",
        text: "NAXT365 addresses these challenges with a modern cloud architecture, dealer-focused workflows, and seamless integrations—enabling faster, smarter, and more agile business operations. This upgrade isn’t just an IT refresh—it’s a business performance transformation.",
      },
      {
        type: "paragraph",
        text: "Built on Microsoft Dynamics 365, NAXT365 unifies every part of your dealership—rental, sales, service, parts, and finance—into a single, future-ready platform. Move beyond NAXT2012 limitations with improved visibility, lower operational risk, and enterprise-grade scalability with our proven expertise.",
      },
      ...
      {
        type: "paragraph",
        text: "Organizations focus on operational efficiency, cost reduction, and customer uptime. NAXT365 helps you unlock:",
      },
      {
        type: "bullets",
        items: [
      ...
      {
        type: "paragraph",
        text: "Every process is connected, measurable, and optimized for performance.",
      },
      ...
      {
        type: "paragraph",
        text: "Upgrading from NAXT2012 doesn’t have to be risky. We handle legacy customizations, data inconsistencies, multi-branch operations, heavy dealer workflows, and integration dependencies—delivering a predictable, low-disruption upgrade that keeps your dealership running smoothly.",
      },
      ...
      {
        type: "paragraph",
        text: "We don’t just upgrade your system—we elevate your operations.",
      },
  ...
  "timesheeet-management": {
    ...
    blocks: [
      // HERO
      {
        ...
        subheading:
          "Track time accurately. Automate approvals. Accelerate billing.",
      ...
      {
        type: "paragraph",
        text: "Manual or disconnected timesheet processes slow down billing, reduce productivity, and create frustration across teams. Organizations need a system that is fast, reliable, compliant, and integrated—without adding admin overhead.",
      },
      {
        type: "paragraph",
        text: "Our Timesheet Management Solution eliminates the delays, errors, and bottlenecks associated with traditional time tracking, giving your teams a smoother, smarter way to manage time.",
      },
        ...
        tiles: [
          {
            ...
            description:
              "Effortless capture of working hours, overtime, and project-wise time.",
          },
          {
            icon: "FiRefreshCcw",
          ...
          },
          {
            ...
            description:
              "Track, submit, and approve timesheets anytime on any device.",
          },
          {
            icon: "FiBarChart2",
      ...
      {
        type: "paragraph",
        text: "This solution doesn’t just track hours—it improves your entire project and billing lifecycle.",
      },
      {
        type: "bullets",
        items: [
      ...
      {
        type: "paragraph",
        text: "Every hour becomes visible. Every approval becomes faster. Every project becomes more profitable.",
      },
      ...
      },
      {
        ...
        stages: [
          ...
          },
          {
            ...
            description:
              "Connect timesheets directly to your invoicing process",
          },
          {
            number: 5,
            icon: "FiTrendingUp",
      ...
      {
        type: "paragraph",
        text: "We don’t just deploy software—we improve how your business tracks time, manages effort, and captures revenue.",
      },
  ...
  "fixed-assets-stocktake": {
    ...
    blocks: [
      ...
      {
        type: "paragraph",
        text: "Tracking assets across multiple locations can be complex and costly. Organizations often struggle with outdated or inaccurate records, time-consuming manual stocktakes, and limited visibility across sites or branches. Staying compliant with accounting and audit requirements adds further pressure, while integrating data with ERP and finance systems can be cumbersome and error-prone.",
      },
      {
        type: "paragraph",
        text: "Our mobile-based Fixed Assets Stocktake Solution addresses these challenges directly, providing real-time reconciliation, automated reporting, and centralized tracking. With full visibility and actionable insights, you can reduce costs, improve compliance, optimize asset utilization, and gain the confidence that every asset is accounted for—no matter where it is.",
      },
        ...
        stages: [
          {
            ...
            description:
              "Catalog all assets and configure the system for your business",
          },
          {
            number: 2,
            icon: "FiTablet",
            ...
            description:
              "Equip teams with scanning tools for efficient field audits",
          },
          {
            number: 3,
            icon: "FiSearch",
          ...
          },
          {
            ...
            description:
              "Instantly detect discrepancies and generate audit-ready reports",
          },
          {
            number: 5,
            icon: "FiTrendingUp",
  ...
  "Azure-devops-project-management": {
    ...
    blocks: [
      ...
      {
        type: "paragraph",
        text: "Dynamics 365 projects can quickly get complicated—multiple environments, customizations, and teams all working in parallel. Without structured pipelines and clear governance, deployments slow down, errors creep in, and operational risks rise. That’s where our Azure DevOps Toolkit comes in. It automates repetitive tasks, ensures compliance, and improves code quality, so your team can focus on delivering value. With streamlined pipelines, real-time visibility, and built-in safeguards, you get faster, safer deployments and smoother project delivery every time.",
      },
        ...
        stages: [
          {
            ...
            description:
              "Install and configure pre-built templates for D365 projects",
          },
          {
            number: 2,
            icon: "FiPlayCircle",
        ...
        tiles: [
          {
            ...
            description:
              "CI/CD templates optimized for Dynamics 365 development",
          },
          {
            icon: "FiClipboard",
